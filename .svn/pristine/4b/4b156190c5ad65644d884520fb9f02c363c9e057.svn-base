...
import editorSeme.controller.builders.TranslateBuilder;
import editorSeme.model.pojo.Translation;

public class DefaultTranslationBuilder extends DefaultBuilder  implements TranslateBuilder{

	private Translation trans;
	
	
	public DefaultTranslationBuilder() {
